...
ROOT_INTRO = (
    ...
    "Выберите раздел кнопками ниже или напишите вопрос текстом. "
    "Например: «расписание», «стоимость обучения», «как поступить», "
    "«деканат Отрадное», «библиотека».\n\n"
    "Указывайте Кампус в запросе, от этого будет зависеть выдаваемая информация: «Отрадное» или «Махон»."
)
